...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    metaTitle: "Septic Tank Cleaning & Maintenance | Eagle Septic Guide",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "24/7 Emergency Septic Service | Eagle Septic Guide",
    metaDescription:
      "Septic backup or overflow? Learn what steps to take immediately, when to call a professional, and what emergency service typically costs.",
    ...
    process: [
      {
        step: 1,
        title: "Call a Septic Professional",
        description:
  ...
  },
  {
    ...
    metaTitle: "Drain Field Repair & Restoration | Eagle Septic Guide",
    metaDescription:
      "Failing drain field? Learn about common causes of drain field failure, repair options, costs, and when full replacement is necessary.",
  ...
  },
  {
    ...
    metaTitle: "New Septic System Installation | Eagle Septic Guide",
    metaDescription:
      "New home or failed system? Learn about system types, installation steps, permits, costs, and how to choose the right contractor.",
    heroHeadline: "New Septic System Installation",
    heroSubheadline:
      "Building a new home or replacing a failed system? Here's how the installation process works — from soil testing and system design to permits, installation, and final inspection.",
    overview:
      "Installing a new septic system is a significant project that requires soil evaluation, engineered design, county permits, careful installation, and final inspection. A full-service septic contractor manages every step so homeowners don't have to coordinate multiple contractors or navigate county regulations alone. A properly installed system is designed for longevity — correctly sized for the household, placed for optimal soil absorption, and built to meet or exceed current codes.",
    included: [
    ...
    process: [
      {
        ...
        description:
          "The contractor performs soil percolation testing and evaluates the lot to determine the right system type, size, and placement. Results drive the design — not guesswork.",
      },
      {
        step: 2,
        title: "Design & Permits",
        description:
          "The contractor creates a system design based on soil conditions and household size, then submits permit applications to the county health department.",
      },
      {
        step: 3,
        title: "Installation",
        description:
          "Once permits are approved, the crew excavates, sets the tank, installs distribution lines, and builds the drain field according to the approved design.",
      },
      {
        step: 4,
        title: "Inspection & Handoff",
        description:
          "The contractor coordinates the county final inspection, resolves any punch-list items, and walks you through how to care for your new system.",
      },
    ],
    warningSigns: [
      {
      ...
      },
      {
        ...
        description:
          "When a drain field fails completely or a tank collapses, replacement is the only option. A qualified professional will confirm this before recommending a new installation.",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "The installation itself typically takes 2–5 days depending on system size and soil conditions. The full timeline — including soil testing, design, and permits — is typically 4–8 weeks. The contractor should provide a project-specific schedule after the site evaluation.",
      },
      {
        question: "How much does a new septic system cost?",
        answer:
          "New system costs vary significantly based on system type, size, soil conditions, and local permit fees. A basic conventional system may cost $10,000–$20,000; advanced systems in challenging soils can run higher. A reputable installer will provide a detailed written estimate after the site evaluation.",
      },
      {
        question: "What types of septic systems do you install?",
        answer:
          "Common system types include conventional gravity systems, pressure distribution systems, mound systems (for shallow soil depth), and aerobic treatment units. The right type is determined by soil test results and local code requirements.",
      },
      {
        question: "Do I need permits for a new septic system?",
        answer:
          "Yes — permits are required in all jurisdictions. A full-service contractor handles the permit application, inspections, and final approval as part of the installation. You shouldn't need to navigate the county offices yourself.",
      },
      {
        question: "How do I take care of my new system?",
        answer:
          "The basics: pump the tank on schedule (every 3–5 years), avoid flushing non-biodegradable items, spread laundry loads throughout the week, and protect the drain field from vehicle traffic and deep-rooted plants. Most installers provide a full homeowner guide after installation.",
      },
    ],
    relatedSlugs: [
      "septic-inspections",
